...
#include <bits/stdc++.h>
#include <stdint.h>
#include "/home/sensei/test_ws/src/my_actuator/RmdApiSerial/rmd-sdk/include/x10_api.h"
...
public:
    ...
    bool reset_odometry_service_callback(std_srvs::Trigger::Request &req, std_srvs::Trigger::Response &res);
...
private:
    ...
    void get_odometry(const ros::TimerEvent &event);
